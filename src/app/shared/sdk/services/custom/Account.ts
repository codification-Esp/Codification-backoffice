...
export class AccountApi extends BaseLoopBackApi {
  ...
  /**
   * Donne l'ensemble des batiments accessibles pour l'étudiant
   *
   * @param {any} id Account id
   *
   * @returns {object[]} An empty reference that will be
   ...
   *   from the server.
   *
   * le tableau des batiments accessibles
   */
  public batimentsAccessibles(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/batiments_Accesibles";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Donne les etages qui sont accessibles dans un batiment donné
   *
   * @param {any} id Account id
   *
   ...
   *   from the server.
   *
   * Le tableau des étages accessibles selon un batiment donné
   */
  public etagesAccessibles(id: any, batiment: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/etages_Accessibles";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof batiment !== 'undefined' && batiment !== null) _urlParams.batiment = batiment;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   *   from the server.
   *
   * vérifier l'etat de la réservation
   */
  public confirmerReservation(id: any, code: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/confirmer_Reservation";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * retourne l'ensemble des batiments disponibles en y incluant les etages et les chambres pour un etudiant donne
   *
   * @param {any} id Account id
   *
   * @returns {object} An empty reference that will be
   ...
   *   from the server.
   *
   * tableau des batiments disponibles inclus leurs etages et leurs chambres
   */
  public chambresAccessibles(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/chambres_Accessibles";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
